...
contract StarNotary is ERC721 {
    ...
    string public constant name = "DLTech";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerOf(_tokenId1) || msg.sender == ownerOf(_tokenId2), "None owned by sender.");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address transferTo = _to1;
        _transferFrom(transferFrom, transferTo, _tokenId);
    }
